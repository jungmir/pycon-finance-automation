...
class Step5TrackPaymentInProgressHandler(BaseHandler):
    """Watch pajunwi for 결제 중. User changes state after making payment and uploading receipt."""

    name = "step5_track_payment_in_progress"
    from_state = "COPIED_TO_PYCON"
    to_state = "PAYMENT_IN_PROGRESS"
    ...
    def execute(self, task: dict):
        ...
        if workflow_name != DOORAY_WORKFLOW_NAME_PAYMENT_IN_PROGRESS:
            return None  # still 결제 대기 중, keep waiting
